...
public class ThursdayTasks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ThursdayTasks.this, CreateNewDailyTask.class));
            }
        });
    ...
    private void setUpRecyclerview(){
        ...
        Query query = allTasksRef.orderBy("time", Query.Direction.DESCENDING)
                .whereArrayContains("tags", "Thursday");
