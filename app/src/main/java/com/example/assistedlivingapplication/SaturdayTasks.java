...
public class SaturdayTasks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(SaturdayTasks.this, CreateNewDailyTask.class));
            }
        });
    ...
    private void setUpRecyclerview(){
        ...
        Query query = allTasksRef.orderBy("time", Query.Direction.DESCENDING)
                .whereArrayContains("tags", "Saturday");
